...
export type MetaDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      ...
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'twitter' | 'image'>> }
    )> }> };

export type NotFoundDataQueryVariables = Exact<{ [key: string]: never; }>;


export type NotFoundDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

export type IndexDataQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: { edges: Array<{ node: (
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      ...
      & { featuredImage?: Maybe<{ childImageSharp?: Maybe<{ original?: Maybe<Pick<ImageSharpOriginal, 'src'>> }> }> }
    )> }
  )> };
